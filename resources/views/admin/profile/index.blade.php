...
@php
    $user = auth()->user();
    $displayName = $user->nama ?? $user->name ?? 'Admin';
...
<div class="navbar">
    ...
    <div class="nav-right">
        <a href="{{ route('admin.profile') }}" style="display: flex; align-items: center; gap: 10px; text-decoration: none; color: inherit;">
            <div class="user-info">
...
<div class="layout">
    ...
    <div class="main-area">
        ...
        <div class="profile-card full-width">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    ...
                    <p class="subtitle">Administrator • {{ $user->email ?? 'admin@klinkhewan.com' }}</p>
                    <span class="badge"><i class="bi bi-shield-check"></i> Admin Terverifikasi</span>
                </div>
            </div>
            ...
            <div class="info-row">
                ...
                <div class="info-value highlight">{{ ucfirst($user->role ?? 'Admin') }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">No. Telepon</div>
                <div class="info-value">{{ $user->nohp ?? '-' }}</div>
            </div>
            <div class="info-row">
        ...
        <div class="profile-container">
            ...
            <div class="profile-card">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value highlight">Full Administrator</div>
                </div>
                <div class="info-row">
                    <div class="info-label">ID Admin</div>
                    <div class="info-value">{{ $user->id_admin ?? 'ADMIN-' . str_pad($user->id ?? '001', 3, '0', STR_PAD_LEFT) }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Tanggal Bergabung</div>
                    <div class="info-value">{{ $user->created_at ? $user->created_at->format('d F Y') : '-' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Status Akun</div>
                    <div class="info-value highlight">Aktif</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Last Login</div>
                    <div class="info-value">{{ $user->last_login ?? now()->format('d F Y, H:i') }} WIB</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Divisi</div>
                    <div class="info-value highlight">Manajemen Sistem</div>
                </div>
            </div>
            ...
            <div class="profile-card">
                ...
                <div class="tag-container">
                    <div class="tag">Manajemen User</div>
                    <div class="tag">Data Master</div>
                    <div class="tag">Sistem Klinik</div>
                    <div class="tag">Database Management</div>
                    <div class="tag">Backup & Recovery</div>
                    <div class="tag">Security System</div>
                    <div class="tag">Report Analytics</div>
                    <div class="tag">Staff Management</div>
                    <div class="tag">Configuration</div>
                    <div class="tag">System Monitoring</div>
                </div>
            </div>
        ...
        <div class="profile-card full-width">
            ...
            <div class="timeline">
                <div class="timeline-item">
                    <h4 class="timeline-title">S2 Sistem Informasi Manajemen</h4>
                    <p class="timeline-meta">Universitas Airlangga • 2016 - 2018</p>
                    <p class="timeline-desc">Fokus pada manajemen sistem informasi rumah sakit dan klinik kesehatan</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">S1 Teknik Informatika</h4>
                    <p class="timeline-meta">Institut Teknologi Sepuluh Nopember • 2012 - 2016</p>
                    <p class="timeline-desc">Spesialisasi database management dan sistem informasi</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Sertifikasi Database Administrator</h4>
                    <p class="timeline-meta">Oracle University • 2017</p>
                    <p class="timeline-desc">Sertifikasi profesional Oracle Certified Professional (OCP)</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Pelatihan Cyber Security</h4>
                    <p class="timeline-meta">BSSN Indonesia • 2019</p>
                    <p class="timeline-desc">Pelatihan keamanan sistem informasi dan data protection</p>
                </div>
            </div>
        </div>
        ...
        <div class="profile-card full-width">
            ...
            <div class="timeline">
                <div class="timeline-item">
                    <h4 class="timeline-title">System Administrator - Klinik Hewan Sehat</h4>
                    <p class="timeline-meta">2020 - Sekarang</p>
                    <p class="timeline-desc">Mengelola sistem informasi klinik, database management, user management, dan keamanan sistem</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">IT Support Specialist - RS Hewan Central</h4>
                    <p class="timeline-meta">2018 - 2020</p>
                    <p class="timeline-desc">Maintenance sistem, troubleshooting, dan support teknis untuk staff rumah sakit</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Junior Programmer - PT Solusi Digital</h4>
                    <p class="timeline-meta">2016 - 2018</p>
                    <p class="timeline-desc">Pengembangan aplikasi sistem informasi untuk instansi kesehatan</p>
                </div>
            </div>
        </div>
        ...
        <div class="profile-container">
            <div class="profile-card">
                ...
                <div class="tag-container">
                    <div class="tag">Database MySQL</div>
                    <div class="tag">PHP Laravel</div>
                    <div class="tag">Linux Server</div>
                    <div class="tag">Network Security</div>
                    <div class="tag">Backup System</div>
            ...
            <div class="profile-card">
                ...
                <div class="tag-container">
                    <div class="tag">User Management</div>
                    <div class="tag">Project Planning</div>
                    <div class="tag">Documentation</div>
                    <div class="tag">Team Coordination</div>
                    <div class="tag">Problem Solving</div>
                    <div class="tag">System Analysis</div>
                </div>
            </div>
        </div>
        ...
        <!-- BUTTON KEMBALI -->
        <div class="profile-card full-width">
            <a href="{{ route('interface.dashboard') }}" class="btn-back">
