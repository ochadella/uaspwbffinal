...
<head>
    <meta charset="UTF-8">
    <title>Manajemen Jadwal Perawat</title>
    ...
    <style>
        ...
        /* ================= STYLE UNTUK KONTEN JADWAL PERAWAT ================= */
        h2 {
            color: #102f76;
            font-weight: 800;
            text-align: center;
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="{{ route('admin.jadwal.perawat') }}" class="sidebar-link active">
    ...
    <div class="main-area">
        <div class="content">
            ...
            <h2>Manajemen Jadwal Perawat</h2>
            <p style="text-align:center;color:#555;margin-bottom:30px;">
                Admin dapat menambahkan jadwal jaga untuk setiap perawat.
            </p>

            <!-- FORM INPUT -->
            <div class="box">
                <h3 style="margin-top:0;color:#102f76;">Tambah Jadwal Perawat</h3>

                <form action="{{ route('admin.jadwal.perawat.store') }}" method="POST">
                    @csrf

                    <label>Pilih Perawat</label>
                    <select name="iduser_perawat" required>
                    ...
                    <label>Ruang</label>
                    <input type="text" name="ruang" placeholder="cth: Ruang A" required>
   ...
   <i class="bi bi-pencil-square"></i>
                            ...
                            <a href="{{ route('admin.jadwal.perawat.delete', $j->id) }}"
...
<!-- ✨ EDIT MODAL UNTUK JADWAL PERAWAT -->
<div id="editModal" 
    ...
    <div style="background:white; padding:24px; border-radius:12px; width:420px; box-shadow:0 6px 20px rgba(0,0,0,.2);">
        ...
        <h3 style="margin-top:0; color:#102f76; text-align:center;">Edit Jadwal Perawat</h3>
        ...
        <form id="editForm" method="POST">
            ...
            <label>Pilih Perawat</label>
            <select name="iduser_perawat" id="edit_perawat" required>
                @foreach ($perawat as $p)
                    <option value="{{ $p->iduser }}">{{ $p->nama }}</option>
                @endforeach
            </select>
...
<script>
function openEditModal(id, perawat, hari, mulai, selesai, ruang) {
    document.getElementById('editModal').style.display = 'flex';

    document.getElementById('edit_perawat').value = perawat;
    ...
    // 🟡 ROUTE UPDATE
    document.getElementById('editForm').action = '/admin/jadwal/perawat/update/' + id;
}
