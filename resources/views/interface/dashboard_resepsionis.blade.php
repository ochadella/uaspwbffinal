...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="{{ route('dashboard.resepsionis') }}" class="sidebar-link active">
    ...
    <div class="main-area">
        <div class="content">
            <div class="page-header">
                ...
                <p>Kelola registrasi pemilik, hewan, dan antrian temu dokter dengan tampilan yang rapi dan konsisten.</p>
            </div>

            <!-- ⭐ 3 CARD DENGAN ICON + BUTTON ⭐ -->
            <div class="card-container">

                <a href="{{ route('resepsionis.pemilik.regris') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                ...
                <a href="{{ route('resepsionis.pet.regris') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                            <i class="bi bi-plus-circle-fill"></i>
                        </div>
                        <h3>Registrasi Pet</h3>
                        <p>Tambah & kelola data hewan</p>
                    </div>
                </a>

                <a href="{{ route('resepsionis.temudokter') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                            <i class="bi bi-calendar-check-fill"></i>
                        </div>
                        <h3>Temu Dokter</h3>
                        <p>🐾 {{ $total_antrian }} antrian menunggu</p>
