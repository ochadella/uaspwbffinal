...
<head>
    ...
    <style>
        ...
        /* ⭐ BUTTON DI CARD (kalau perlu nanti) */
        .card-button {
            margin-top: 14px;
            padding: 8px 16px;
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="{{ route('interface.dashboard_dokter') }}" class="sidebar-link active">
    ...
    <div class="main-area">
        <div class="content">
            <div class="page-header">
                ...
                <p>Kelola data pasien, rekam medis, jadwal pemeriksaan, dan master data hewan dengan tampilan yang rapi dan konsisten.</p>
            </div>
            ...
            <div class="card-container">
                ...
                <!-- Data Rekam Medis -->
                <a href="{{ route('dokter.rekammedis.index') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                            <i class="bi bi-journal-medical"></i>
                        </div>
                        <h3>Data Rekam Medis</h3>
                        <p>Lihat dan tinjau rekam medis pasien yang telah diinput perawat.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('dokter.pasien.index') }}" class="card-link">
                    <div class="card">
                        ...
                        <h3>Data Pasien</h3>
                        <p>Lihat daftar pasien aktif beserta informasi pemilik dan hewan peliharaan.</p>
                    </div>
                </a>

                <!-- Jadwal Pemeriksaan -->
                <a href="{{ route('dokter.jadwal.index') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                            <i class="bi bi-calendar-check"></i>
                        </div>
                        <h3>Jadwal Pemeriksaan</h3>
                        <p>Pantau jadwal pemeriksaan pasien dan waktu praktik Anda.</p>
                ...
                <!-- Data Jenis Hewan -->
                <a href="{{ route('dokter.jenishewan.index') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                            <i class="bi bi-bug"></i>
                        </div>
                        <h3>Data Jenis Hewan</h3>
                        <p>Lihat daftar jenis hewan yang terdaftar di sistem rekam medis.</p>
                    </div>
                </a>

                <!-- Data Ras Hewan -->
                <a href="{{ route('dokter.rashewan.index') }}" class="card-link">
                    <div class="card">
                        <div class="card-icon">
                            <i class="bi bi-bug-fill"></i>
                        </div>
                        <h3>Data Ras Hewan</h3>
                        <p>Lihat informasi detail ras dari setiap jenis hewan yang terdaftar.</p>
                    </div>
                </a>
