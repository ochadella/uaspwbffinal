...
<head>
    ...
    <title>Riwayat Kunjungan | Pemilik</title>
...
<div class="navbar">
    <div class="nav-left">
        ...
        <div>
            ...
            <div class="brand-text-sub">Riwayat Kunjungan</div>
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('pemilik.kunjungan.index') }}" class="sidebar-link active">
    ...
    <div class="main-area">
        <div class="content">
                ...
                <div class="page-title-group">
                    ...
                    <div class="page-title-texts">
                        ...
                        <div class="page-subtitle">
                            Daftar kunjungan hewan Anda yang telah selesai dilayani di klinik.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align:center; padding:20px; color:#777;">
                                Belum ada riwayat kunjungan selesai.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
            ...
            <a href="{{ route('dashboard.pemilik') }}" class="btn-back">← Kembali ke Dashboard</a>
