...
<head>
    ...
    <title>Rekam Medis | Pemilik Hewan</title>
    ...
    <style>
        ...
        .btn-detail {
            ...
            font-weight: 700;
            font-size: 12px;
            box-shadow: 0 4px 12px rgba(249,160,27,0.45);
        ...
        .btn-detail:hover {
            ...
            box-shadow: 0 6px 16px rgba(249,160,27,0.6);
        }
...
<div class="navbar">
    <div class="nav-left">
        ...
        <div>
            ...
            <div class="brand-text-sub">Rekam Medis</div>
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('pemilik.rekammedis.index') }}" class="sidebar-link active">
            ...
            <div class="page-header">
                <div class="page-title-group">
                    ...
                    <div class="page-title-texts">
                        <div class="page-title">Rekam Medis Hewan Anda</div>
                        <div class="page-subtitle">
                            Riwayat pemeriksaan hewan yang telah dilakukan oleh dokter.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('pemilik.rekammedis.detail',$rm->idtemu_dokter) }}" class="btn-detail">
                    ...
                    @empty
                    <tr>
                        <td colspan="10" style="padding:20px; color:#555;">
                            Belum ada rekam medis tersedia.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
