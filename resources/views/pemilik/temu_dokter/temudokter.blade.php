...
<head>
    ...
    <title>Jadwal Temu Dokter - Pemilik</title>
...
<div class="navbar">
    <div class="nav-left">
        ...
        <div>
            ...
            <div class="brand-text-sub">Jadwal Temu Dokter</div>
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('pemilik.temudokter.index') }}" class="sidebar-link active">
    ...
    <div class="main-area">
        <div class="content">
            ...
            <div class="page-header">
                <div class="page-title-group">
                    ...
                    <div class="page-title-texts">
                        <div class="page-title">Jadwal Temu Dokter</div>
                        <div class="page-subtitle">
                            Daftar konsultasi hewan Anda yang telah dibuat oleh resepsionis.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <a href="{{ route('dashboard.pemilik') }}" class="btn-back">
