...
<head>
    ...
    <style>
        ...
        .nav-search input { border:none; outline:none; flex:1; font-size:13px; }
...
$displayRole = ucfirst(auth()->user()->role ?? 'Dokter');
...
<div class="navbar">
    <div class="nav-left">
        ...
        <div>
            <div class="brand-text-title">RS Hewan Peliharaan</div>
    ...
    <div class="nav-center">
        <div class="nav-search">
            ...
            <input type="text" placeholder="Cari ras hewan...">
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <a href="{{ route('interface.dashboard_dokter') }}" class="sidebar-header" style="text-decoration:none;color:inherit;">
        ...
        <a href="{{ route('dokter.jenishewan.index') }}" class="sidebar-link">
            <i class="bi bi-bug"></i> Data Jenis Hewan
        </a>

        <a href="{{ route('dokter.rashewan.index') }}" class="sidebar-link active">
            <i class="bi bi-bug-fill"></i> Data Ras Hewan
        </a>
    ...
    <div class="content">
        ...
        <div class="page-header">
            <i class="bi bi-bug-fill page-header-icon"></i>
            <h1>Data Ras Hewan</h1>
            <p>Data ini hanya dapat dibaca oleh dokter (read-only).</p>
        </div>
        ...
        <table>
            ...
            @empty
                <tr>
                    <td colspan="3" style="color:#555;">Belum ada data ras hewan.</td>
                </tr>
            @endforelse
            </tbody>
        </table>
        ...
        <div class="footer-note">
            RS Hewan Peliharaan — Melayani dengan Sepenuh Hati 💙
        </div>
