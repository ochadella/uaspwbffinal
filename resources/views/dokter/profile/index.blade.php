...
@php
    $user = auth()->user();
    $displayName = $user->nama ?? $user->name ?? 'Dokter';
...
<div class="navbar">
    ...
    <div class="nav-right">
        <a href="{{ route('dokter.profile') }}" style="display: flex; align-items: center; gap: 10px; text-decoration: none; color: inherit;">
            <div class="user-info">
    ...
    <div class="main-area">
        ...
        <div class="profile-card full-width">
            <div class="profile-header">
                <div>
                    <div class="profile-avatar" onclick="openUploadModal()">
                        @if(isset($user->foto_profile) && $user->foto_profile)
                            <img src="{{ asset('storage/' . $user->foto_profile) }}" alt="Foto Profile">
                        @else
                            {{ $initial }}
                        @endif
                ...
                <div class="profile-info">
                    <h2>drh. {{ $user->nama ?? $displayName }}</h2>
                    <p class="subtitle">Dokter Hewan • {{ $user->email ?? 'email@klinik.com' }}</p>
            ...
            <div class="info-row">
                ...
                <div class="info-value highlight">{{ ucfirst($user->role ?? 'Dokter') }}</div>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $user->tanggal_lahir ?? '15 Agustus 1990' }}</div>
            </div>
            <div class="info-row">
        ...
        <div class="profile-container">
            ...
            <div class="profile-card">
                ...
                <div class="info-row">
                    <div class="info-label">Nomor STRV</div>
                    <div class="info-value highlight">{{ $user->no_strv ?? 'STRV-123456789' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Masa Berlaku STRV</div>
                    <div class="info-value">{{ $user->masa_berlaku_strv ?? '31 Desember 2025' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Nomor SIPV</div>
                    <div class="info-value highlight">{{ $user->no_sipv ?? 'SIPV-987654321' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Masa Berlaku SIPV</div>
                    <div class="info-value">{{ $user->masa_berlaku_sipv ?? '31 Desember 2025' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">ID Anggota PDHI</div>
                    <div class="info-value">{{ $user->id_pdhi ?? 'PDHI-2024-001' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Spesialisasi</div>
                    <div class="info-value highlight">{{ $user->spesialisasi ?? 'Bedah Hewan & Dermatologi' }}</div>
                </div>
            </div>
            ...
            <div class="profile-card">
                ...
                <div class="tag-container">
                    <div class="tag">Vaksinasi</div>
                    <div class="tag">Pemeriksaan Umum</div>
                    <div class="tag">Bedah Minor</div>
                    <div class="tag">Reproduksi & Obstetri</div>
                    <div class="tag">Hewan Eksotik</div>
                    <div class="tag">Lab Diagnostik</div>
                    <div class="tag">Grooming Medis</div>
                    <div class="tag">Dental Care</div>
                    <div class="tag">Emergency Care</div>
                    <div class="tag">Radiologi</div>
                </div>
            </div>
        ...
        <div class="profile-card full-width">
            ...
            <div class="timeline">
                <div class="timeline-item">
                    <h4 class="timeline-title">Profesi Dokter Hewan</h4>
                    <p class="timeline-meta">Fakultas Kedokteran Hewan Universitas Airlangga • 2014</p>
                    <p class="timeline-desc">Lulus dengan predikat Cum Laude, IPK 3.85</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">S1 Kedokteran Hewan</h4>
                    <p class="timeline-meta">Fakultas Kedokteran Hewan Universitas Airlangga • 2009 - 2013</p>
                    <p class="timeline-desc">Program studi Kedokteran Hewan dengan fokus pada kesehatan hewan kecil</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Pelatihan Bedah Hewan</h4>
                    <p class="timeline-meta">PDHI Jawa Timur • 2015</p>
                    <p class="timeline-desc">Sertifikasi kompetensi bedah minor dan mayor pada hewan kecil</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Magang Klinik</h4>
                    <p class="timeline-meta">RS Hewan Jakarta • 2014</p>
                    <p class="timeline-desc">6 bulan magang intensif di rumah sakit hewan rujukan nasional</p>
                </div>
            </div>
        </div>
        ...
        <div class="profile-card full-width">
            ...
            <div class="timeline">
                <div class="timeline-item">
                    <h4 class="timeline-title">Dokter Hewan Senior - Klinik Hewan Sehat</h4>
                    <p class="timeline-meta">2020 - Sekarang</p>
                    <p class="timeline-desc">Menangani kasus medis hewan kecil, bedah minor, dan konsultasi kesehatan hewan peliharaan</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Dokter Hewan - RS Hewan Central</h4>
                    <p class="timeline-meta">2016 - 2020</p>
                    <p class="timeline-desc">Praktik umum dan emergency pada hewan kecil, handling exotic pets</p>
                </div>

                <div class="timeline-item">
                    <h4 class="timeline-title">Asisten Dokter Hewan - Pet Clinic 24</h4>
                    <p class="timeline-meta">2014 - 2016</p>
                    <p class="timeline-desc">Pemeriksaan rutin, vaksinasi, dan perawatan pasca operasi</p>
                </div>
            </div>
        </div>
        ...
        <div class="profile-container">
            <div class="profile-card">
                ...
                <div class="tag-container">
                    <div class="tag">Rawat Jalan</div>
                    <div class="tag">Vaksinasi</div>
                    <div class="tag">Ultrasound</div>
                    <div class="tag">Bedah Minor</div>
                    <div class="tag">Dental Scaling</div>
                    <div class="tag">Emergency Handling</div>
                    <div class="tag">Anestesi</div>
                    <div class="tag">Radiologi Dasar</div>
                    <div class="tag">Penanganan Hewan Agresif</div>
                </div>
            </div>
            ...
            <div class="profile-card">
                ...
                <div class="tag-container">
                    ...
                    <div class="tag">Manajemen Klinik</div>
                    <div class="tag">Dokumentasi Medis</div>
                    <div class="tag">Inventory Management</div>
                    <div class="tag">Medical Report</div>
                    <div class="tag">Team Coordination</div>
                </div>
            </div>
        </div>
        ...
        <!-- BUTTON KEMBALI -->
        <div class="profile-card full-width">
            <a href="{{ route('interface.dashboard_dokter') }}" class="btn-back">
...
<script>
    ...
    document.getElementById('formUploadPhoto').addEventListener('submit', function(e) {
        ...
        fetch('{{ route("dokter.profile.upload") }}', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function deletePhoto() {
        if (confirm('Apakah Anda yakin ingin menghapus foto profil?')) {
            fetch('{{ route("dokter.profile.delete-photo") }}', {
                method: 'POST',
                headers: {
