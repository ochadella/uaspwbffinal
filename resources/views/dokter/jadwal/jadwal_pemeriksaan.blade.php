...
<head>
    ...
    <style>
        ...
        /* ================= NAVBAR (SAMA DENGAN PANEL DOKTER LAIN) ================= */
        .navbar {
            position: sticky;
            top: 0;
            z-index: 50;
        ...
        /* ================= SIDEBAR (PLEK KETIPLEK PANEL DOKTER) ================= */
        .sidebar {
            width: 215px;
            border-radius: 24px;
        ...
        .btn-back {
            padding:7px 16px;
            border-radius:999px;
            background:linear-gradient(135deg,#f9a01b,#ff9554);
            color:#102f76;
            font-weight:700;
            font-size:13px;
            text-decoration:none;
...
<div class="navbar">
    ...
    <div class="nav-center">
        <div class="nav-search">
            ...
            <input type="text" placeholder="Cari jadwal pemeriksaan...">
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('dokter.jadwal.index') }}" class="sidebar-link active">
    ...
    <div class="content">
        ...
        <div class="page-header">
            <i class="bi bi-calendar2-week page-header-icon"></i>
            <h1>Jadwal Pemeriksaan Dokter</h1>
            <p>Daftar jadwal pemeriksaan Anda di RS Hewan Peliharaan.</p>
        </div>
            ...
            @empty
                <tr>
                    <td colspan="5" style="text-align:center;color:#555;">
                        Belum ada jadwal pemeriksaan untuk Anda.
                    </td>
                </tr>
            @endforelse
            </tbody>
