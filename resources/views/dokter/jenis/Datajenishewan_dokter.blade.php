...
<head>
    ...
    <style>
        ...
        .page-header-icon {
            ...
            background:#f9a01b33; padding:20px; border-radius:50%;
...
<div class="navbar">
    ...
    <div class="nav-center">
        <div class="nav-search">
            ...
            <input type="text" placeholder="Cari jenis hewan...">
        </div>
    </div>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <a href="{{ route('dokter.jadwal.index') }}" class="sidebar-link">
            <i class="bi bi-calendar-week"></i> <span>Jadwal Pemeriksaan</span>
        </a>

        <a href="{{ route('dokter.jenishewan.index') }}" class="sidebar-link active">
    ...
    <div class="content">
        ...
        <div class="page-header">
            <i class="bi bi-bug page-header-icon"></i>
            <h1>Data Jenis Hewan</h1>
            <p>Data jenis hewan hanya dapat dibaca oleh dokter (read only).</p>
        </div>
        ...
        <table>
            ...
            @empty
                <tr>
                    <td colspan="2" style="color:#555; text-align:center;">Belum ada data jenis hewan.</td>
                </tr>
            @endforelse
            </tbody>
        </table>
