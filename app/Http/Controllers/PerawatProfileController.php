...
class PerawatProfileController extends Controller
{
    ...
    {
        $user = Auth::user(); // ambil data perawat login

        return view('perawat.profile.index', compact('user'));
    }

    /*
    |--------------------------------------------------------------------------
    | 🔥 FUNGSI UPLOAD FOTO PROFIL PERAWAT
    |--------------------------------------------------------------------------
    | Upload foto profil perawat dengan validasi dan penghapusan foto lama.
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | 🔥 FUNGSI HAPUS FOTO PROFIL PERAWAT
    |--------------------------------------------------------------------------
    | Menghapus foto profil perawat dan mengembalikan ke default.
    */
